...
# Coletor MULTICIDADES para CASAS à venda.
...
CITY_CONFIGS = [
    {
        ...
        "estado": "SP",
        "slug_cidade": "boituva",
        "base_url": "https://www.olx.com.br/imoveis/venda/casas/estado-sp/regiao-de-sorocaba/boituva",
    },
    {
        "cidade": "Sorocaba",
        "estado": "SP",
        "slug_cidade": "sorocaba",
        "base_url": "https://www.olx.com.br/imoveis/venda/casas/estado-sp/regiao-de-sorocaba/sorocaba",
    },
    {
        "cidade": "Itu",
        "estado": "SP",
        "slug_cidade": "itu",
        "base_url": "https://www.olx.com.br/imoveis/venda/casas/estado-sp/regiao-de-sorocaba/itu",
    },
    {
        "cidade": "Tatuí",
        "estado": "SP",
        "slug_cidade": "tatui",
        "base_url": "https://www.olx.com.br/imoveis/venda/casas/estado-sp/regiao-de-sorocaba/tatui",
    },
    {
        "cidade": "Porto Feliz",
        "estado": "SP",
        "slug_cidade": "porto-feliz",
        "base_url": "https://www.olx.com.br/imoveis/venda/casas/estado-sp/regiao-de-sorocaba/porto-feliz",
    },
    {
        "cidade": "Cerquilho",
        "estado": "SP",
        "slug_cidade": "cerquilho",
        "base_url": "https://www.olx.com.br/imoveis/venda/casas/estado-sp/regiao-de-sorocaba/cerquilho",
    },
]

CURRENT_CITY_CONFIG = CITY_CONFIGS[0]
BASE_URL = CURRENT_CITY_CONFIG["base_url"]
HISTORICAL_CSV = "output/imoveis_olx_casas_historico.csv"
...
def is_probable_listing_url(link: str) -> bool:
    ...
    if re.search(r"-\d{6,}", link_lower):
        # Para o coletor de casas, aceita anúncios de imóveis com slug contendo casa/casas.
        if "casa" in link_lower or "casas" in link_lower:
            return True

    if ("/casas" in link_lower or "casa-" in link_lower or "/casa" in link_lower) and re.search(r"\d{6,}", link_lower):
        return True
...
def main() -> None:
    ...
    with sync_playwright() as p:
        ...
        for config in CITY_CONFIGS:
            ...
            print("\n" + "#" * 80)
            print(f"Iniciando coleta de CASAS em {config['cidade']}/{config['estado']}")
    ...
    full_output_path = f"output/imoveis_olx_casas_full_{timestamp_arquivo}.csv"
    new_output_path = f"output/imoveis_olx_casas_novos_{timestamp_arquivo}.csv"
    updated_output_path = f"output/imoveis_olx_casas_atualizados_{timestamp_arquivo}.csv"
    removed_output_path = f"output/imoveis_olx_casas_removidos_{timestamp_arquivo}.csv"
